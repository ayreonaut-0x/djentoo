...
DESCRIPTION="Full XanMod source with Task Type scheduler, including the Gentoo patchset and other patch options."
...
SRC_URI="
	...
	cjktty? ( ${CJKTTY_URI}/cjktty-${KV_MAJOR}.${KV_MINOR}.patch )
"
