...
src_prepare() {
	...
	use nap-governor && _patchlist+=( "${DISTDIR}/nap-governor-${CACHYOS_VERSION}.patch" )
	use poc-selector && _patchlist+=( "${DISTDIR}/poc-selector-${CACHYOS_VERSION}.patch" )
	use reflex-governor && _patchlist+=( "${DISTDIR}/reflex-governor-${CACHYOS_VERSION}.patch" )
