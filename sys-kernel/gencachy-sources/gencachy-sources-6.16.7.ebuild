...
CACHYOS_COMMIT="a6659635a7ec2426b8f7ef280e9a405a2325f556"
...
SRC_URI="
	...
	${CACHYOS_GIT_URI}/misc/0001-aufs-6.16-merge-v20250804.patch -> 0001-aufs-${CACHYOS_VERSION}.patch
...
src_prepare() {
	local _patchlist=(
		...
		"${WORKDIR}/1801_proc_fix_type_confusion_in_pde_set_flags.patch"
