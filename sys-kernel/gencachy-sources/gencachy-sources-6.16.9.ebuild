...
CACHYOS_COMMIT="214dcce9a6fa99f4551ce1f255e10c0c1b156789"
...
SRC_URI="
	...
	${CACHYOS_GIT_URI}/misc/0001-aufs-6.16-merge-v20250922.patch -> 0001-aufs-${CACHYOS_VERSION}.patch
...
src_prepare() {
	local _patchlist=(
		...
		"${WORKDIR}/1007_linux-6.16.8.patch"
		"${WORKDIR}/1008_linux-6.16.9.patch"
