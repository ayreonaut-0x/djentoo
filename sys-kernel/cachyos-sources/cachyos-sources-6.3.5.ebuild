...
src_prepare() {
	eapply "${FILESDIR}/${KV_MAJOR}.${KV_MINOR}/0001-cachyos-base-all.patch"
	...
	if use eevdf; then
		eapply "${FILESDIR}/${KV_MAJOR}.${KV_MINOR}/0001-EEVDF.patch"
      eapply "${FILESDIR}/${KV_MAJOR}.${KV_MINOR}/0001-bore-eevdf.patch"
	fi

	if use high-hz; then
		eapply "${FILESDIR}/${KV_MAJOR}.${KV_MINOR}/0001-high-hz.patch"
	fi
